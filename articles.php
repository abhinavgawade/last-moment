...
// Fetch user's articles with category info and author profile image
$stmt = $pdo->prepare("
    SELECT 
        a.*, 
    ...
    WHERE a.user_id = ? 
    GROUP BY a.id, c.name, u.profile_image, u.username
                                    ...
                                    <div class="card article-card h-100">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <span class="small text-muted"><?php echo htmlspecialchars($article['author_name']); ?></span>
                                            </div>
